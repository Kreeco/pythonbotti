...
def load_model_from_config(config, ckpt, verbose=False):
    print(f"Alustetaan.... Ladataan kuvagenerointimallia kohteesta {ckpt}")
    ...
    #model.half() mahdollisuus puolittaa tehonsyönti
                    ...
                    for n in trange(self.n_iter, desc="Sampling"):
                        for prompts in tqdm(self.data, desc="data"):
                            ...
                            for x_sample in x_checked_image_torch:
                                ...
                                img.save(rf'{self.img_path}\{filename}.png')
                                self.base_count += 1
